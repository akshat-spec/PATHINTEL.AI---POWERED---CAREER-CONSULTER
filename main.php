...
<?php include 'header.php'?>
		...
		<div id="home" class="hero-area">
			...
			<!-- Animated Background -->
			<!-- Background Image -->
		<div class="bg-image bg-parallax" style="background-image:url(./img/main_hero_bg.png); width:100%; height: 656px;"></div>
		<!-- /Background Image -->
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						...
						<h2 style="margin-top: 100px; font-size: 45px;">Welcome to PathIntel.ai</h2>
						...
						<p class="lead"><b style="color: rgb(56, 48, 48);">PathIntel.ai</b> is one stop destination <br>in helping you understand yourself, the best career for you <br> and providing all the resources in the process.</p>
					</div>
				</div>	
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="section-header">
							<h2 style="font-size: 35px;">About PathIntel.ai</h2>
