			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<div class="navbar-brand">
						<a class="logo" href="main.php">PathIntel.ai</a>
					</div>
					<!-- /Logo -->
				...
				<nav id="nav">
					<ul class="main-menu nav navbar-nav navbar-right">
						...
						<!-- Dark Mode Toggle -->
						<li>
							<button id="dark-mode-toggle" class="theme-toggle-btn" style="margin-left: 15px; margin-top: 15px;">
